...
var Portal = React29.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime14.jsx)(React29.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime14.jsx)(React29.Fragment, {
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React70.useRef(false);
  const firstFocus = React70.useRef(true);
  const inputRef = React70.useRef(null);
  const listboxRef = React70.useRef(null);
  const [anchorEl, setAnchorEl] = React70.useState(null);
  const [focusedTag, setFocusedTag] = React70.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React70.useRef(defaultHighlighted);
  ...
  const resetInputValue = React70.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React70.useState(true);
  ...
  const syncHighlightedIndex = React70.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React70.useRef(false);
...
var InputBase = React72.forwardRef(function InputBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime50.jsxs)(React72.Fragment, {
...
var OutlinedInput = React73.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime52.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime52.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime51.jsxs)(React73.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IJO66U4R.js.map
